export default function PostDesignCardB({
  ...
  return (
    <div
      ...
      className={`max-w-xs md:max-w-sm lg:max-w-md mx-6 my-20 shadow-themeShadow bg-[#C2B6B6]/50 ${animate}`}
    >
      <div
        //style={{ border: '1px solid purple' }}
      ...
      >
        <div>
          ...
          <img src="./card/heart.svg" alt="heart" className="h-5 w-5 cursor-pointer" />
        </div>
        <div>
          <p className="text-themeBrown text-center">
            <small>{comments.length}</small>
          </p>
          <img src="./card/comments.svg" alt="comments" className="h-5 w-5 cursor-pointer" />
        </div>
        <div>
          <p className="text-themeBrown text-center">
            <small>{countOfVisitors}</small>
          </p>
          <img src="./card/views.svg" alt="views" className="h-5 w-5 cursor-pointer" />
        </div>
        <div className="ml-3 mt-4">
          <img src="./card/share.svg" alt="views" className="h-6 w-6 cursor-pointer" />
        </div>
      </div>
      <a href="#">
